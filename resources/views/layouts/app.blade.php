            ...
            <div class="navbar__link-box t-end">
                <p class="navbar__link-box__p">
                    <a class="navbar__link-box__p__link" href="tel:+36209834929">+36 20 983 4929
                        <img class="navbar__link-box__p__link__img" src="img/header/map.svg" alt="szenna"> </a>
                </p>
                <p class="navbar__link-box__p">
                    <a class="navbar__link-box__p__link" target="_blank"
                        ...
                        Szenna, Árpád utca 39. <img class="navbar__link-box__p__link__img" src="img/header/phone.svg"
                            alt="szenna"> </a>
                </p>
            </div>
        </nav>
